...
/**
 * Schema XML de validação da área de dados da mensagem de manutenção OCR
 * 
 * <p>Classe Java de TManOCR complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="TManOCR">
 *   &lt;complexContent>
...
@XmlType(name = "TManOCR", propOrder = {
    "tpAmb",
    "verAplic",
    "tpMan",
    "dReg",
...
public class TManOCR {
    ...
    @XmlElement(name = "cOCR", required = true)
    protected String cocr;
    @XmlElement(name = "xOCR", required = true)
